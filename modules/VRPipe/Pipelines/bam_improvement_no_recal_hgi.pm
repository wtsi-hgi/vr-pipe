...
class VRPipe::Pipelines::bam_improvement_no_recal_hgi with VRPipe::PipelineRole {
    method name {
        return 'bam_improvement_no_recal_hgi';
    }
    
    method description {
        return 'Improves bam files by realigning around indels, and adding NM and BQ tags. Does no quality score recalibration, useful when dealing with species that diverge from reference greatly or have no/few SNP calls';
    }
