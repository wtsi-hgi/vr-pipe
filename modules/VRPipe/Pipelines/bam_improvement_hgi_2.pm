...
class VRPipe::Pipelines::bam_improvement_hgi_2 with VRPipe::PipelineRole {
    method name {
        return 'bam_improvement_hgi_2';
    }
    
    method description {
        return 'Improves bam files by realigning around known and discovered indels, recalibrating quality scores and adding NM and BQ tags.';
    }
